...
const NavBar = ({ collapsed, setCollapsed }: NavbarProps) => {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      link: '/teacher/class-management/list',
      subMenu: [
        { title: 'Danh sách lớp học', link: '/teacher/class-management/list' },
        { title: 'Thêm buổi học mới', link: '/teacher/class-management/add' },
        { title: 'Tham gia vào lớp học', link: '/teacher/class-management/join' },
      ],
    },
    {
      ...
      title: 'Bài kiểm tra',
      link: '/teacher/test-management/list',
      subMenu: [
        { title: 'Danh sách bài kiểm tra', link: '/teacher/test-management/list' },
        { title: 'Thêm bài kiểm tra mới', link: '/teacher/test-management/add' },
        { title: 'Nhập điểm', link: '/teacher/test-management/enter-scores' },
        { title: 'Bảng điểm', link: '/teacher/test-management/scoreboard' },
      ],
    },
    {
