...
const GradedTest = () => {
    ...
    const filteredData = tests
        .filter((item) => item.graded === "Đã chấm")  // Lọc bài kiểm tra đã chấm
    ...
    return (
        <div className="p-6 bg-white shadow-md rounded-lg mt-1">
            <div className="flex justify-between items-end rounded-lg shadow-md p-4">
